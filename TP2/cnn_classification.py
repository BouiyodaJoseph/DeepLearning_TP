...
print(f"Forme des étiquettes d'entraînement (y_train shape): {y_train.shape}")
print("--------------------------------------\n")

# ============================================================================
# PARTIE 2 : IMPLÉMENTATION D'UN CNN CLASSIQUE
# ============================================================================
...
def build_basic_cnn(input_shape, num_classes):
    ...
    model = keras.Sequential([
        ...
        # 'padding="same"' assure que la taille de l'image en sortie est la même.
        ...
        # Divise la hauteur et la largeur de l'image par 2.
...
# (Le code précédent du CNN de base reste ici...)
# ...
# print(f"\nPrécision sur l'ensemble de test : {test_acc:.4f}")
# print("--------------------------------------\n")
...
# ============================================================================
# PARTIE 2 (SUITE) : EXERCICE 2 - BLOCS RÉSIDUELS (RESNETS)
# ============================================================================

# --- Définition de la fonction du bloc résiduel ---

def residual_block(x, filters, stride=1):
    """Construit un bloc résiduel simplifié."""
    ...
    # Chemin du raccourci (Skip Connection path)
    shortcut = x
    # Si le stride est > 1 ou si le nombre de filtres change,
    # on doit ajuster le raccourci pour que les dimensions correspondent.
    ...
    # Activation finale après l'addition
...
def build_mini_resnet(input_shape, num_classes):
    ...
    # Une couche de convolution initiale pour traiter l'image
    ...
    # Bloc résiduel 2 (stride=2 pour réduire la taille de l'image)
    ...
    x = keras.layers.GlobalAveragePooling2D()(x) # Mieux que Flatten pour les CNNs profonds
